...
class SmartTeamTranslation {
  ...
  constructor() {
    ...
    console.log(
      "🔄 [SmartTranslation] Initialized with cache cleared for fresh translations and automated mappings integrated",
    );
  }
  ...
  private cleanCorruptedLearnedMappings(): void {
    ...
    this.learnedTeamMappings.forEach((mapping, teamName) => {
      Object.entries(mapping).forEach(([lang, translation]) => {
        if (
          ...
          this.isCorruptedTranslation(translation, teamName)
        ) {
    ...
    if (cleanedCount > 0) {
      ...
      console.log(
        `🧹 [SmartTranslation] Cleaned ${cleanedCount} corrupted learned mappings`,
      );
    }
  }
  ...
  private popularLeagueTeams: TeamTranslation = {
    ...
    "Atlanta United FC": {
      ...
      "zh-hk": "亞特蘭大聯",
      "zh-tw": "亞特蘭大聯",
      es: "Atlanta United FC",
      de: "Atlanta United FC",
      it: "Atlanta United FC",
      pt: "Atlanta United FC",
    },
    "Seattle Sounders": {
      zh: "西雅图海湾人",
      "zh-hk": "西雅圖海灣人",
    ...
    "Seattle Sounders FC": {
      ...
      "zh-hk": "西雅圖海灣人",
      "zh-tw": "西雅圖海灣人",
      es: "Seattle Sounders FC",
      de: "Seattle Sounders FC",
      it: "Seattle Sounders FC",
    ...
    "Athletico Paranaense": {
      ...
      "zh-hk": "巴拉那競技",
      "zh-tw": "巴拉那競技",
      es: "Athletico Paranaense",
      de: "Athletico Paranaense",
      it: "Athletico Paranaense",
      pt: "Athletico Paranaense",
    },
    "Athletico-PR": {
      zh: "巴拉那竞技",
      "zh-hk": "巴拉那競技",
    ...
    "Central Córdoba de Santiago": {
      ...
      "zh-hk": "聖地亞哥中央科爾多瓦",
      "zh-tw": "聖地亞哥中央科爾多瓦",
      es: "Central Córdoba de Santiago",
      de: "Central Córdoba de Santiago",
      it: "Central Córdoba de Santiago",
      pt: "Central Córdoba de Santiago",
    },
    ...
    "Gimnasia La Plata": {
      ...
      "zh-hk": "拉普拉塔體操",
      "zh-tw": "拉普拉塔體操",
      es: "Gimnasia La Plata",
      de: "Gimnasia La Plata",
      it: "Gimnasia La Plata",
      pt: "Gimnasia La Plata",
    },
    Estudiantes: {
      zh: "拉普拉塔大学生",
      "zh-hk": "拉普拉塔大學生",
    ...
    "Universidad de Chile": {
      ...
      it: "Universidad de Chile",
      pt: "Universidad de Chile",
    },
    ...
    "Atlético Nacional": {
      ...
      it: "Atlético Nacional",
      pt: "Atlético Nacional",
    },
    "Atletico Nacional": {
      zh: "国民竞技",
      "zh-hk": "國民競技",
    ...
    "Albacete Balompié": {
      ...
      it: "Albacete Balompié",
      pt: "Albacete Balompié",
    },
    "CD Leganes": {
      zh: "莱加内斯",
      "zh-hk": "萊加內斯",
    ...
    "Cultural y Deportiva Leonesa": {
      ...
      "zh-hk": "萊昂文化體育",
      "zh-tw": "萊昂文化體育",
      es: "Cultural y Deportiva Leonesa",
      de: "Cultural y Deportiva Leonesa",
      it: "Cultural y Deportiva Leonesa",
      pt: "Cultural y Deportiva Leonesa",
    },
    "SD Compostela": {
      zh: "孔波斯特拉",
      "zh-hk": "孔波斯特拉",
    ...
    "TSG 1899 Hoffenheim": {
      ...
      "zh-hk": "賀芬咸",
      "zh-tw": "霍芬海姆",
      es: "TSG 1899 Hoffenheim",
      de: "TSG 1899 Hoffenheim",
      it: "TSG 1899 Hoffenheim",
      pt: "TSG 1899 Hoffenheim",
    },
    Hoffenheim: {
      zh: "霍芬海姆",
      "zh-hk": "賀芬咸",
    ...
    "Terranuova Traiana": {
      ...
      "zh-hk": "特拉努奧瓦特萊亞納",
      "zh-tw": "特拉努奧瓦特萊亞納",
      es: "Terranuova Traiana",
      de: "Terranuova Traiana",
      it: "Terranuova Traiana",
      pt: "Terranuova Traiana",
    },
    Arezzo: {
      zh: "阿雷佐",
      "zh-hk": "阿雷佐",
    ...
    "Enosis Neon Paralimni": {
      ...
      "zh-hk": "埃諾西斯",
      "zh-tw": "埃諾西斯",
      es: "Enosis Neon Paralimni",
      de: "Enosis Neon Paralimni",
      it: "Enosis Neon Paralimni",
      pt: "Enosis Neon Paralimni",
    },
    ...
    "Ceramica Cleopatra": {
      ...
      "zh-hk": "克利奧帕特拉陶瓷",
      "zh-tw": "克利奧帕特拉陶瓷",
      es: "Ceramica Cleopatra",
      de: "Ceramica Cleopatra",
      it: "Ceramica Cleopatra",
      pt: "Ceramica Cleopatra",
    },
    "Zamalek SC": {
      zh: "扎马雷克",
      "zh-hk": "扎馬雷克",
    ...
    "Alianza Petrolera": {
      ...
      "zh-hk": "石油聯盟",
      "zh-tw": "石油聯盟",
      es: "Alianza Petrolera",
      de: "Alianza Petrolera",
      it: "Alianza Petrolera",
      pt: "Alianza Petrolera",
    },
    ...
    "Independ. Rivadavia": {
      ...
      "zh-hk": "里瓦達維亞獨立",
      "zh-tw": "里瓦達維亞獨立",
      es: "Independiente Rivadavia",
      de: "Independiente Rivadavia",
      it: "Independiente Rivadavia",
      pt: "Independiente Rivadavia",
    },
    ...
    "Detonit Plachkovica": {
      ...
      "zh-hk": "德托尼特普拉奇科維察",
      "zh-tw": "德托尼特普拉奇科維察",
      es: "Detonit Plachkovica",
      de: "Detonit Plachkovica",
      it: "Detonit Plachkovica",
      pt: "Detonit Plachkovica",
    },
    "Sloga Vinica": {
      zh: "斯洛加维尼察",
      "zh-hk": "斯洛加維尼察",
    ...
    "Guadalajara Chivas": {
      ...
      "zh-hk": "瓜達拉哈拉芝華士",
      "zh-tw": "瓜達拉哈拉芝華士",
      es: "Guadalajara Chivas",
      de: "Guadalajara Chivas",
      it: "Guadalajara Chivas",
      pt: "Guadalajara Chivas",
    },
    "Hamburger SV": {
      zh: "汉堡",
      "zh-hk": "漢堡",
    ...
    "Olimpija Ljubljana": {
      ...
      "zh-hk": "盧布爾雅那奧林比亞",
      "zh-tw": "盧布爾雅那奧林匹亞",
      es: "Olimpija Ljubljana",
      de: "Olimpija Ljubljana",
      it: "Olimpija Ljubljana",
      pt: "Olimpija Ljubljana",
    },
    "NK Olimpija Ljubljana": {
      zh: "卢布尔雅那奥林匹亚",
      "zh-hk": "盧布爾雅那奧林比亞",
      "zh-tw": "盧布爾雅那奧林匹亞",
      es: "NK Olimpija Ljubljana",
      de: "NK Olimpija Ljubljana",
      it: "NK Olimpija Ljubljana",
      pt: "NK Olimpija Ljubljana",
    },
    "Egnatia Rrogozhinë": {
      zh: "罗戈日纳埃格纳蒂亚",
      "zh-hk": "羅戈日納埃格納蒂亞",
      "zh-tw": "羅戈日納埃格納蒂亞",
      es: "Egnatia Rrogozhinë",
      de: "Egnatia Rrogozhinë",
      it: "Egnatia Rrogozhinë",
      pt: "Egnatia Rrogozhinë",
    },
    "KF Egnatia": {
      zh: "罗戈日纳埃格纳蒂亚",
      "zh-hk": "羅戈日納埃格納蒂亞",
    ...
    "FC Differdange 03": {
      ...
      "zh-hk": "迪費當熱03",
      "zh-tw": "迪費當熱03",
      es: "FC Differdange 03",
      de: "FC Differdange 03",
      it: "FC Differdange 03",
      pt: "FC Differdange 03",
    },
    "FC Levadia Tallinn": {
      zh: "塔林莱瓦迪亚",
      "zh-hk": "塔林萊瓦迪亞",
      "zh-tw": "塔林萊瓦迪亞",
      es: "FC Levadia Tallinn",
      de: "FC Levadia Tallinn",
      it: "FC Levadia Tallinn",
      pt: "FC Levadia Tallinn",
    },
    Polessya: {
      zh: "波利西亚",
      "zh-hk": "波利西亞",
    ...
    "Istanbul Basaksehir": {
      ...
      "zh-hk": "伊斯坦布爾巴薩克謝希爾",
      "zh-tw": "伊斯坦布爾巴薩克謝希爾",
      es: "Istanbul Başakşehir",
      de: "Istanbul Başakşehir",
    ...
    "Spouwen-Mopertingen": {
      ...
      "zh-hk": "斯波文莫珀廷根",
      "zh-tw": "斯波文莫珀廷根",
      es: "Spouwen-Mopertingen",
      de: "Spouwen-Mopertingen",
      it: "Spouwen-Mopertingen",
      pt: "Spouwen-Mopertingen",
    },
    ...
    "New England Revolution": {
      ...
      "zh-hk": "新英格蘭革命",
      "zh-tw": "新英格蘭革命",
      es: "New England Revolution",
      de: "New England Revolution",
      it: "New England Revolution",
      pt: "New England Revolution",
    },
    "Chicago Fire": {
      zh: "芝加哥火焰",
      "zh-hk": "芝加哥火焰",
    ...
    "Minnesota United FC": {
      ...
      "zh-hk": "明尼蘇達聯",
      "zh-tw": "明尼蘇達聯",
      es: "Minnesota United FC",
      de: "Minnesota United FC",
      it: "Minnesota United FC",
      pt: "Minnesota United FC",
    },
    "Real Salt Lake": {
      zh: "皇家盐湖城",
      "zh-hk": "皇家鹽湖城",
    ...
    "Deportivo Pereira": {
      ...
      it: "Deportivo Pereira",
      pt: "Deportivo Pereira",
    },
    "Rionegro Aguilas": {
      zh: "里奥内格罗老鹰",
      "zh-hk": "里奧內格羅老鷹",
    ...
    "FK Crvena Zvezda": {
      ...
      "zh-tw": "貝爾格萊德紅星",
      es: "FK Crvena Zvezda",
      de: "FK Roter Stern Belgrad",
      it: "FK Stella Rossa Belgrado",
      pt: "FK Estrela Vermelha",
    },
    "Slovan Bratislava": {
      zh: "布拉迪斯拉发斯洛万",
      "zh-hk": "布拉迪斯拉發斯洛萬",
    ...
    "Red Bull Salzburg": {
      ...
      de: "Red Bull Salzburg",
      it: "Red Bull Salzburg",
    ...
    "Rak��w Częstochowa": {
      ...
      "zh-hk": "琴斯托霍瓦拉科夫",
      "zh-tw": "琴斯托霍瓦拉科夫",
      es: "Raków Częstochowa",
      de: "Raków Częstochowa",
      it: "Raków Częstochowa",
      pt: "Raków Częstochowa",
    },
    "Rakow Czestochowa": {
      zh: "琴斯托霍瓦拉科夫",
      "zh-hk": "琴斯托霍瓦拉科夫",
    ...
    "Vikingur Reykjavik": {
      ...
      "zh-hk": "雷克雅未克維京",
      "zh-tw": "雷克雅未克維京",
      es: "Vikingur Reykjavik",
      de: "Vikingur Reykjavik",
      it: "Vikingur Reykjavik",
      pt: "Vikingur Reykjavik",
    },
    Brondby: {
      zh: "布隆德比",
      "zh-hk": "布隆德比",
    ...
    "St Patrick's Athl.": {
      ...
      "zh-hk": "聖柏德烈競技",
      "zh-tw": "聖派翠克競技",
      es: "St Patrick's Athletic",
      de: "St Patrick's Athletic",
      it: "St Patrick's Athletic",
      pt: "St Patrick's Athletic",
    },
    ...
    "Universitatea Craiova": {
      ...
      "zh-hk": "克拉約瓦大學",
      "zh-tw": "克拉約瓦大學",
      es: "Universitatea Craiova",
      de: "Universitatea Craiova",
      it: "Universitatea Craiova",
      pt: "Universitatea Craiova",
    },
  };

  // Get direct translation from popular teams mapping
  private getPopularTeamTranslation(
    teamName: string,
    language: string,
  ): string | null {
    ...
    if (teamTranslations) {
      const exactTranslation =
        teamTranslations[language as keyof typeof teamTranslations];
    ...
    if (learnedTeamTranslations) {
      const learnedTranslation =
        learnedTeamTranslations[
          language as keyof typeof learnedTeamTranslations
        ];
      if (
        learnedTranslation &&
        learnedTranslation !== teamName &&
        !this.isCorruptedTranslation(learnedTranslation, teamName)
      ) {
        console.log(
          `🎓 [SmartTranslation] Using learned mapping: "${teamName}" -> "${learnedTranslation}" (${language})`,
        );
        ...
        console.log(
          `🧹 [SmartTranslation] Removing corrupted learned mapping for: "${teamName}"`,
        );
        this.learnedTeamMappings.delete(teamName);
        this.saveLearnedMappings();
      }
    ...
    if (cleanMatch) {
      const translation =
        this.popularLeagueTeams[cleanMatch][
          language as keyof TeamTranslation[string]
        ];
    ...
    if (
      teamNameLower.includes("los angeles galaxy") ||
      teamNameLower === "la galaxy"
    ) {
      const translation =
        this.popularLeagueTeams["Los Angeles Galaxy"]?.[
          language as keyof TeamTranslation[string]
        ];
      if (translation) return translation;
    }
    ...
    if (teamNameLower.includes("new york red bulls")) {
      const translation =
        this.popularLeagueTeams["New York Red Bulls"]?.[
          language as keyof TeamTranslation[string]
        ];
      if (translation) return translation;
    }
    ...
    if (teamNameLower === "charlotte" || teamNameLower === "charlotte fc") {
      const translation =
        this.popularLeagueTeams["Charlotte"]?.[
          language as keyof TeamTranslation[string]
        ];
      if (translation) return translation;
    }
    ...
    if (teamNameLower === "fc cincinnati" || teamNameLower === "cincinnati") {
      const translation =
        this.popularLeagueTeams["FC Cincinnati"]?.[
          language as keyof TeamTranslation[string]
        ];
      if (translation) return translation;
    }
    ...
    if (teamNameLower === "fc juarez" || teamNameLower === "juarez") {
      const translation =
        this.popularLeagueTeams["FC Juarez"]?.[
          language as keyof TeamTranslation[string]
        ];
      if (translation) return translation;
    }
    ...
    for (const [mappedTeam, translations] of Object.entries(
      this.popularLeagueTeams,
    )) {
      const mappedTeamLower = mappedTeam.toLowerCase();

      // More sophisticated partial matching
      if (
        teamNameLower.includes(mappedTeamLower) ||
        mappedTeamLower.includes(teamNameLower)
      ) {
        const translation =
          translations[language as keyof TeamTranslation[string]];
        if (translation) return translation;
      }

      // Word-based matching (minimum 4 characters to avoid false positives)
      const teamWords = teamNameLower
        .split(/\s+/)
        .filter((word) => word.length >= 4);
      const mappedWords = mappedTeamLower
        .split(/\s+/)
        .filter((word) => word.length >= 4);

      // If any significant word matches
      if (
        teamWords.some((word) => mappedWords.includes(word)) ||
      ...
      const normalizedTeam = teamNameLower
        .replace(/['']/g, "'")
        .replace(/[–-]/g, "-");
      const normalizedMapped = mappedTeamLower
        .replace(/['']/g, "'")
        .replace(/[–-]/g, "-");
  ...
  getLeagueTeams(leagueId: number): any[] | null {
    if (this.leagueTeamsCache[leagueId]) {
      console.log(
        `📊 [SmartTranslation] Found ${this.leagueTeamsCache[leagueId].length} cached teams for league ${leagueId}`,
      );
  ...
  learnTeamsFromFixtures(fixtures: any[]): void {
    ...
    if (newMappingsCount > 0) {
      this.saveLearnedMappings();
      console.log(
        `📖 [SmartTranslation] Learned ${newMappingsCount} new team mappings from fixtures`,
      );
    }
  }
  ...
  private shouldLearnTeamMapping(teamName: string): boolean {
    ...
    if (
      this.popularLeagueTeams[teamName] ||
      this.learnedTeamMappings.has(teamName)
    ) {
      return false;
    }
    ...
    try {
      ...
      if (automatedData) {
        ...
        if (data.teams) {
          ...
          console.log(
            `🤖 [SmartTranslation] Loaded ${this.automatedMappings.size} automated mappings`,
          );
        }
      }
    } catch (error) {
      console.warn(
        "🚨 [SmartTranslation] Failed to load automated mappings:",
        error,
      );
  ...
  async initializeTeamTranslations(language: string): Promise<void> {
    try {
      console.log(
        `🔄 [SmartTranslation] Initializing team translations for language: ${language}`,
      );
      ...
      console.log(
        `✅ [SmartTranslation] Successfully initialized for ${language} with ${this.learnedTeamMappings.size} learned mappings`,
      );
    } catch (error) {
      console.error(
        `❌ [SmartTranslation] Failed to initialize for ${language}:`,
        error,
      );
    }
  }
  ...
  learnFromTranslationContext(
    ...
    console.log(
      `🎓 [SmartTranslation] Learned new translation: "${originalName}" -> "${translatedName}" (${language})`,
    );
  }
  ...
  forceRefreshTranslations(teams: string[], language: string = "zh-hk"): void {
    teams.forEach((team) => {
      ...
      if (learnedMapping) {
        const translation =
          learnedMapping[language as keyof typeof learnedMapping];
        if (translation && this.isCorruptedTranslation(translation, team)) {
          console.log(
            `🧹 [SmartTranslation] Removing corrupted learned mapping: "${team}" -> "${translation}"`,
          );
      ...
      console.log(
        `🔄 [SmartTranslation] Force refreshed: ${team} for ${language}`,
      );
    });
  ...
  cacheLeagueTeams(leagueId: number, teams: any[]): void {
    if (teams && teams.length > 0) {
      ...
      console.log(
        `💾 [SmartTranslation] Cached ${teams.length} teams for league ${leagueId}`,
      );
    }
  }
  ...
  private loadLearnedMappings(): void {
    try {
      ...
      if (stored) {
        ...
        console.log(
          `🎓 [SmartTranslation] Loaded ${this.learnedTeamMappings.size} learned mappings from localStorage`,
        );
      }
    } catch (error) {
      console.warn(
        "🚨 [SmartTranslation] Failed to load learned mappings:",
        error,
      );
  ...
  private saveLearnedMappings() {
    try {
      const mappingsObject = Object.fromEntries(
        this.learnedTeamMappings.entries(),
      );
      localStorage.setItem(
        "smart_translation_learned_mappings",
        JSON.stringify(mappingsObject),
      );
    } catch (error) {
      console.warn(
        "🚨 [SmartTranslation] Failed to save learned mappings:",
        error,
      );
    }
  }
  ...
  private getEnhancedFallback(
    ...
    const automatedTranslation = this.getAutomatedTeamTranslation(
      teamName,
      language,
    );
    ...
    if (cleanedName !== teamName && cleanedName.length > 2) {
      const cleanTranslation = this.getPopularTeamTranslation(
        cleanedName,
        language,
      );
  ...
  private getAutomatedTeamTranslation(
    teamName: string,
    language: string,
  ): string | null {
    try {
  ...
  private generateSmartPhoneticTranslation(
    teamName: string,
    language: string,
  ): string | null {
    ...
    for (let i = 0; i < Math.min(cleanName.length, 6); i++) {
  ...
  generateComprehensiveMapping(fixtures: any[]): { [key: string]: string } {
    ...
    console.log(
      `🎯 [SmartTranslation] Generated mapping for ${Object.keys(mapping).length} teams needing translation`,
    );
    return mapping;
  }
    ...
    leagueIds.forEach((leagueId) => {
      ...
      teams.forEach((team: any) => {
        if (team?.teams?.home?.name) {
          mapping[team.teams.home.name] = this.createMappingTemplate(
            team.teams.home.name,
          );
        }
        if (team?.teams?.away?.name) {
          mapping[team.teams.away.name] = this.createMappingTemplate(
  ...
  integrateAutomatedMappings(): void {
    try {
      ...
      if (automatedData) {
        ...
        console.log(
          `🤖 [SmartTranslation] Found automated mappings for ${data.teams || 0} teams`,
        );

        // Store reference to automated data for quick access
        this.automatedMappingsCache = data;
        console.log(
          `✅ [SmartTranslation] Integrated automated mappings cache`,
        );
      }
      ...
      if (completeMapping) {
        ...
        console.log(
          `📋 [SmartTranslation] Found complete team mapping data with ${completeData.totalTeams || 0} teams`,
        );
        ...
        if (completeData.allTeamsSortedByFrequency) {
          ...
          this.saveLearnedMappings();
          console.log(
            `🎓 [SmartTranslation] Integrated ${completeData.allTeamsSortedByFrequency.length} teams from complete mapping`,
          );
        }
      }
    } catch (error) {
  ...
  bulkUpdateFromAutomatedMappings(
    automatedMappings: Record<string, any>,
  ): void {
    let updatedCount = 0;
    ...
    Object.entries(automatedMappings).forEach(([teamName, translations]) => {
      if (typeof translations === "object" && translations !== null) {
        ...
        if (!this.popularLeagueTeams[teamName]) {
          this.learnedTeamMappings.set(
            teamName,
            translations as TeamTranslation,
          );
          updatedCount++;
        }
      }
    ...
    if (updatedCount > 0) {
      this.saveLearnedMappings();
      console.log(
        `📦 [SmartTranslation] Bulk updated ${updatedCount} team translations`,
      );
    }
  }
  ...
  translateLeagueName(leagueName: string, language: string = "zh-hk"): string {
    ...
    console.log(
      `🏆 [SmartTranslation] Translating league: "${leagueName}" to ${language}`,
    );
    ...
    if (this.teamCache.has(cacheKey)) {
      ...
      console.log(
        `💾 [SmartTranslation] League cache hit: "${leagueName}" -> "${cached}"`,
      );
      return cached;
    }
    ...
    if (exactTranslation && exactTranslation[language]) {
      ...
      console.log(
        `✅ [SmartTranslation] League exact match: "${leagueName}" -> "${translation}"`,
      );
      return translation;
    }
    ...
    for (const [pattern, translations] of Object.entries(leagueTranslations)) {
      if (
        lowerLeagueName.includes(pattern.toLowerCase()) ||
        pattern.toLowerCase().includes(lowerLeagueName)
      ) {
        const translation = translations[language] || pattern;
        this.teamCache.set(cacheKey, translation);
        console.log(
          `🔍 [SmartTranslation] League pattern match: "${leagueName}" -> "${translation}"`,
        );
        return translation;
      }
    }
    ...
    console.log(
      `❌ [SmartTranslation] No league translation found for: "${leagueName}"`,
    );
    return leagueName;
  }
  ...
  translateCountryName(
    ...
    console.log(
      `🌍 [SmartTranslation] Translating country: "${countryName}" to ${language}`,
    );
    ...
    if (this.teamCache.has(cacheKey)) {
      const cached = this.teamCache.get(cacheKey)!;
      console.log(
        `💾 [SmartTranslation] Country cache hit: "${countryName}" -> "${cached}"`,
      );
      return cached;
    }
    ...
    if (exactTranslation && exactTranslation[language]) {
      ...
      this.teamCache.set(cacheKey, translation);
      console.log(
        `✅ [SmartTranslation] Country exact match: "${countryName}" -> "${translation}"`,
      );
      return translation;
    }
    ...
    console.log(
      `❌ [SmartTranslation] No country translation found for: "${countryName}"`,
    );
    return countryName;
  }
  ...
  translateTeamName(
    ...
    console.log(
      `🤖 [SmartTranslation] Translating "${teamName}" to ${language}`,
      {
        isLoading: this.isLoading,
        cacheSize: this.teamCache.size,
        leaguesLoaded: Object.keys(this.leagueTeamsCache).length,
        totalCachedTeams: Object.values(this.leagueTeamsCache).reduce(
    ...
    if (this.teamCache.has(cacheKey)) {
      ...
      if (!this.isCorruptedTranslation(cached, teamName)) {
        console.log(
          `💾 [SmartTranslation] Cache hit: "${teamName}" -> "${cached}"`,
        );
        return cached;
      } else {
        console.log(
          `🧹 [SmartTranslation] Clearing corrupted cache for: "${teamName}"`,
        );
        this.teamCache.delete(cacheKey);
      }
    }
    ...
    const popularTranslation = this.getPopularTeamTranslation(
      teamName,
      language,
    );
    if (
      popularTranslation &&
      popularTranslation !== teamName &&
      !this.isCorruptedTranslation(popularTranslation, teamName)
    ) {
      console.log(
        `⭐ [SmartTranslation] Popular team translation: "${teamName}" -> "${popularTranslation}"`,
      );
    ...
    if (
      manualTranslation &&
      manualTranslation !== teamName &&
      !this.isCorruptedTranslation(manualTranslation, teamName)
    ) {
      console.log(
        `📖 [SmartTranslation] Manual translation: "${teamName}" -> "${manualTranslation}"`,
      );
    ...
    if (
      enhancedFallback &&
      enhancedFallback !== teamName &&
      !this.isCorruptedTranslation(enhancedFallback, teamName)
    ) {
      console.log(
        `🔍 [SmartTranslation] Enhanced fallback: "${teamName}" -> "${enhancedFallback}"`,
      );
    ...
    console.log(
      `❌ [SmartTranslation] No translation available for: "${teamName}"`,
    );
  ...
  private isCorruptedTranslation(
    translation: string,
    original: string,
  ): boolean {
  ...
  private learnNewTeam(teamName: string, leagueInfo?: any): void {
    ...
    try {
      ...
      if (
        leagueInfo.teams &&
        leagueInfo.teams.home?.name === teamName &&
        leagueInfo.teams.home?.translated_name
      ) {
        translatedName = leagueInfo.teams.home.translated_name;
      } else if (
        leagueInfo.teams &&
        leagueInfo.teams.away?.name === teamName &&
        leagueInfo.teams.away?.translated_name
      ) {
      ...
      if (translatedName !== teamName) {
        ...
        if (existingMapping && existingMapping[teamName]) {
          existingMapping[teamName][
            language as keyof (typeof existingMapping)[typeof teamName]
          ] = translatedName;
          ...
          console.log(
            `🎓 [SmartTranslation] Learned new mapping from league info: "${teamName}" -> "${translatedName}" (${language})`,
          );
        }
      } else {
      ...
      console.warn(
        "⚠️ [SmartTranslation] Failed to learn new team mapping from league info:",
        error,
      );
    }
  }
