...
const translations = {
  ...
  'es': {
    ...
    'winter_friendlies': 'Amigables de Invierno',
  ...
  'pt': {
    ...
    'no_live_matches_main': "Não acontece muitas vezes, mas não há jogos ao vivo a decorrer neste momento.",
  ...
  'zh-tw': {
    ...
    'popular_football_leagues': "熱門足球聯賽",
    'popular_football_teams': "熱門足球隊",
    'popular_football_live_score': "熱門足球即時比分",
    'leagues_cup': "聯賽盃",
    'world': "世界",
    'ended': "已結束",
    'no_matches_available': '暫無比賽',
