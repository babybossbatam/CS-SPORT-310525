        ...
        <div className="w-full max-w-md">
          ...
          <Card className="bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl rounded-lg">
            ...
            {activeTab === "register" && isPhoneInputFocused && (
              <div className="absolute left-full ml-4 top-1/2 transform -translate-y-1/2 bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 text-sm text-white/90 whitespace-nowrap min-w-max z-50 flex items-center">
                Please enter {(() => {
                  const selectedCountry = countryCodes.find(c => c.code === selectedCountryCode);
