                                ...
                                <div className="grid grid-cols-3 gap-4">
                                  <div className="text-center">
                                    ...
                                    <p className="text-lg font-bold text-gray-900">
                                      {todayFixtures.reduce((sum, match) => sum + (match.goals.home || 0) + (match.goals.away || 0), 0)} Goals
                                    </p>
                                  </div>
                                  <div className="text-center">
                                    <h4 className="text-sm font-semibold text-gray-700">Result</h4>
                                    <p className="text-lg font-bold text-gray-900">
                                      {todayFixtures.filter(match => match.fixture.status.short === "FT").length} Finished
                                    </p>
                                  </div>
                                  <div className="text-center">
                                    <h4 className="text-sm font-semibold text-gray-700">Fixtures</h4>
                                    <p className="text-lg font-bold text-gray-900">
                                      {todayFixtures.length} Matches
                                    </p>
                                  </div>
                                </div>
                                <button 
