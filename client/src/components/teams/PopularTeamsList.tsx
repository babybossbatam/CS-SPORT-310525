    ...
    const fetchPopularTeams = async () => {
      try {
        ...
        if (teams && teams.length > 0) {
          console.log(`✅ [PopularTeamsList] Fetched ${teams.length} popular teams from API`);
          ...
          const transformedTeams = teams
            ...
            .filter((team: any) => {
              ...
              return !teamName.includes('reserves') && 
        ...
        console.error('❌ [PopularTeamsList] Error fetching popular teams:', error);
