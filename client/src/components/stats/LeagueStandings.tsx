    ...
    <Card className="w-full h-full">
      ...
      <CardContent>
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center justify-between">
            <h4 className="font-medium">Top Scorers</h4>
          </div>
            ...
            {standings.slice(0, 3).map((standing) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <div className="font-medium text-sm">{standing.team.name}</div>
                    <div className="text-xs text-neutral-500">{standing.all.goals.for} Goals</div>
                  </div>
                </div>
              </div>
            ))}
