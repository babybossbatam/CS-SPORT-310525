    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Personalize your sports experience</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Fan Dashboard</h2>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={!favoriteTeamId || addFavoriteTeamMutation.isPending}
                >
            ...
            <DialogContent>
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={!favoriteLeagueId || addFavoriteLeagueMutation.isPending}
                >
      ...
      <Tabs defaultValue="favorites" className="w-full">
        ...
        <TabsContent value="favorites" className="space-y-4">
          {(favoriteTeamIds.length === 0 && favoriteLeagueIds.length === 0) ? (
            <Card>
                ...
                <section className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                    {favoriteLeagueIds.map(leagueId => {
                      const league = favoriteLeagues.find(l => l.id === leagueId) || {
                        id: leagueId,
        ...
        <TabsContent value="fixtures">
          <Card>
            ...
            <CardContent>
              {upcomingFixturesQuery.isLoading ? (
                <div className="space-y-3">
                  <Skeleton className="h-16 w-full" />
                  <Skeleton className="h-16 w-full" />
                  <Skeleton className="h-16 w-full" />
                </div>
              ) : upcomingTeamFixtures.length === 0 ? (
                ...
                <div className="space-y-3">
                  {upcomingTeamFixtures.map(fixture => (
                    <div key={fixture.id} className="border rounded-lg p-3 hover:bg-gray-50 cursor-pointer" onClick={() => navigate(`/match/${fixture.id}`)}>
                      ...
                      {favoriteTeamIds.includes(fixture.homeTeam.id) || favoriteTeamIds.includes(fixture.awayTeam.id) ? (
          ...
          <Card>
            ...
            <CardContent>
              {favoriteLeagueIds.length === 0 ? (
                ...
                <div className="space-y-2">
                  {favoriteLeagueIds.slice(0, 1).map(leagueId => {
                    const league = favoriteLeagues.find(l => l.id === leagueId);
                  ...
                  {favoriteLeagueIds.length > 1 && (
                    <div className="text-center pt-2">
                      <Button 
                        variant="link" 
                        onClick={() => navigate('/leagues')}
                      >
                        View all {favoriteLeagueIds.length} favorite leagues
                      </Button>
                    </div>
                  )}
                </div>
