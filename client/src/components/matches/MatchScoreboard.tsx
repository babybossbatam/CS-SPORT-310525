...
export function MatchScoreboard({ 
  ...
  return (
    <>
      ...
      <div 
        className={`flex relative h-[66px] rounded-md ${compact ? 'mb-4' : 'mb-8'} transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'} mt-[-8px]`}
        onClick={onClick}
        style={{ 
        ...
        <div className="w-full h-full flex justify-between relative">
          {/* Home team logo */}
            <img 
              ...
              />
              <div className={`absolute left-[110px] text-white font-bold text-xl uppercase transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{top: "calc(50% - 10px)", fontFamily: "Calibri"}}>
          ...
          {/* Team name */}
          <div className={`absolute right-[110px] text-white font-bold text-xl uppercase text-right transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{top: "calc(50% - 10px)"}}>
