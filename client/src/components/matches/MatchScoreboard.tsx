        ...
        <div className="w-full h-full flex justify-between relative">
          {/* Home team logo */}
            <img 
              ...
              />
              <div className={`absolute left-20 text-black dark:text-white font-bold text-sm uppercase bg-white/10 backdrop-blur-sm transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{top: "calc(50% - 10px)", fontFamily: "Calibri"}}>
          ...
          {/* Team name */}
          <div className={`absolute right-20 text-black dark:text-white font-bold text-sm uppercase text-right bg-white/10 backdrop-blur-sm transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{top: "calc(50% - 10px)"}}>
