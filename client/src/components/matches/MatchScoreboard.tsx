    ...
    <>
      ...
      >
        ...
        <div className="w-full h-full flex justify-between relative">
          ...
          <div className={`h-full w-[calc(50%-67px)] ml-[77px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
          ...
          <div className={`h-full w-[calc(50%-26px)] mr-[26px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
