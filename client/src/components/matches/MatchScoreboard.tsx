    ...
    <>
      ...
      >
        ...
        <div className="w-full h-full flex justify-between relative">
          ...
          <div className={`h-full w-[calc(35%-47px)] ml-[57px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
          ...
          <div className={`h-full w-[calc(35%-56px)] mr-[46px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
