...
export function MatchScoreboard({ 
  ...
  return (
    <>
      ...
      <div 
        className={`flex relative h-[36px] rounded-md ${compact ? 'mb-4' : 'mb-8'} transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'} mt-[-20px]`}
        onClick={onClick}
        style={{ 
      ...
      >
        ...
        <div className="w-full h-full flex justify-between relative">
          ...
          <div className={`h-full w-[calc(50%-47px)] ml-[57px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
          ...
          <div className={`h-full w-[calc(50%-56px)] mr-[46px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
