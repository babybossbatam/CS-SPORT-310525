        ...
        <div className="w-full h-full flex justify-between relative">
          {/* Home team logo */}
            <img 
                ...
                className={`absolute left-[41px] z-20 w-[72px] h-[72px] object-contain transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
                style={{
                  cursor: onClick ? 'pointer' : 'default',
                  top: "calc(50% - 36px)"
                }}
          ...
          <div className={`h-full w-[calc(50%-66px)] mr-[66px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
          ...
          <img 
            ...
            className={`absolute right-[61px] z-20 w-[72px] h-[72px] object-contain transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
            style={{
              cursor: onClick ? 'pointer' : 'default',
              top: "calc(50% - 36px)"
            }}
