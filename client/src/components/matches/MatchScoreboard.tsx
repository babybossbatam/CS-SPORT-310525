        ...
        <div className="w-full h-full flex justify-between relative">
          {/* Home team logo */}
            <img 
                ...
                className={`absolute left-[1px] z-20 w-[72px] h-[72px] object-contain transition-transform duration-300 ease-in-out hover:scale-110 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
                style={{
                  cursor: onClick ? 'pointer' : 'default',
                  top: "calc(50% - 36px)"
                }}
          ...
          <div 
            className={`absolute text-white font-bold text-sm rounded-full h-[52px] w-[52px] flex items-center justify-center z-30 border-2 border-white overflow-hidden transition-all duration-300 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
            style={{
              background: '#a00000',
              left: 'calc(50% - 26px)',
              top: 'calc(50% - 26px)'
          ...
          <div className={`h-full w-[calc(50%-46px)] mr-[66px] transition-all duration-500 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`} 
            style={{ 
          ...
          <img 
            ...
            className={`absolute right-[11px] z-20 w-[72px] h-[72px] object-contain transition-transform duration-300 ease-in-out hover:scale-110 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
            style={{
              cursor: onClick ? 'pointer' : 'default',
              top: "calc(50% - 36px)"
            }}
