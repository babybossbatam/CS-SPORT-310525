...
const MyNewLeague: React.FC<MyNewLeagueProps> = ({
  ...
  const leagueIds = [38, 15, 71, 22, 72, 73, 75, 128, 233, 667, 253]; // Added Brazilian Serie A (71), CONCACAF Gold Cup (22), Serie B (72), Serie C (73), Serie D (75), Copa Argentina (128), Iraqi League (233), Friendlies Clubs (667), and MLS (253)
    ...
    <>
      ...
      {Object.values(matchesByLeague)
        .sort((a, b) => {
          ...
          const priorityOrder = [38, 15, 71, 22, 72, 73, 75, 128, 233, 667, 253]; // UEFA U21, FIFA Club World Cup, Serie A, CONCACAF Gold Cup, Serie B, Serie C, Serie D, Copa Argentina, Iraqi League, Friendlies Clubs, MLS
