...
const MyNewLeagueComponent: React.FC<MyNewLeagueProps> = ({
  ...
  const leagueIds = [38, 15, 2, 11, 71, 3, 848,  22, 72, 73, 75, 233,  667, 253, 850, 893,  531, 921, 886, 493]; // Added UEFA Champions League (2), CONMEBOL Sudamericana (11), Brazilian Serie A (71), CONCACEF Gold Cup (22), Serie B (72), Serie C (73), Serie D (75), Iraqi League (233), UEFA Europa Conference League (848), Friendlies Clubs (667), MLS (253), and additional leagues (850, 893, 3, 531, 921, 886, 493)
