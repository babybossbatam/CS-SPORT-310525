                ...
                {currentMatch && (
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      const liveMatches = todaysMatches.filter(match => 
                        ["LIVE", "LIV", "1H", "HT", "2H", "ET", "BT", "P", "INT"].includes(match.fixture.status.short)
                      );
                      
                      const endedMatches = todaysMatches.filter(match => 
                        ["FT", "AET", "PEN"].includes(match.fixture.status.short)
                      );
                      
                      const upcomingMatches = todaysMatches.filter(match => 
                      ...
                      return (
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-20">
                          <div className="text-center mb-3">
                            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                              {t("todays_matches") || "Today's Matches"}
                            </h3>
                          </div>
                              ...
                              <div>
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  <span className="text-xs font-medium text-red-600 dark:text-red-400">
                                    {t("live") || "LIVE"} ({liveMatches.length})
                                  </span>
                                </div>
                                {liveMatches.slice(0, 3).map(match => (
                                  <div
                                    key={match.fixture.id}
                                    className="flex items-center justify-between p-2 bg-red-50 dark:bg-red-900/20 rounded cursor-pointer hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
                                    onClick={() => navigate(`/match/${match.fixture.id}`)}
                                  >
                                    <div className="flex items-center gap-2 flex-1 min-w-0">
                                      <img
                                        src={match.teams.home.id ? `/api/team-logo/square/${match.teams.home.id}?size=24` : match.teams.home.logo}
                                      ...
                                      />
                                      <span className="text-xs truncate">{translateTeamName(match.teams.home.name)}</span>
                                    </div>
                                    <div className="text-xs font-medium text-red-600 dark:text-red-400 mx-2">
                                      {match.goals.home ?? 0} - {match.goals.away ?? 0}
                                    </div>
                                    <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                                      <span className="text-xs truncate">{translateTeamName(match.teams.away.name)}</span>
                                      <img
                                        src={match.teams.away.id ? `/api/team-logo/square/${match.teams.away.id}?size=24` : match.teams.away.logo}
                              ...
                              <div>
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  <span className="text-xs font-medium text-gray-600 dark:text-gray-400">
                                    {t("ended") || "ENDED"} ({endedMatches.length})
                                  </span>
                                </div>
                                {endedMatches.slice(0, 3).map(match => (
                                  <div
                                    key={match.fixture.id}
                                    className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-800/50 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                                    onClick={() => navigate(`/match/${match.fixture.id}`)}
                                  >
                                    <div className="flex items-center gap-2 flex-1 min-w-0">
                                      <img
                                    ...
                                    <div className="text-xs font-medium text-gray-700 dark:text-gray-300 mx-2">
                                      {match.goals.home ?? 0} - {match.goals.away ?? 0}
                                    </div>
                                    <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                                      <span className="text-xs truncate">{translateTeamName(match.teams.away.name)}</span>
                            ...
                            {upcomingMatches.length > 0 && (
                              <div>
                                ...
                                {upcomingMatches.slice(0, 3).map(match => (
                                  <div
                                    key={match.fixture.id}
                                    className="flex items-center justify-between p-2 bg-blue-50 dark:bg-blue-900/20 rounded cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                                    onClick={() => navigate(`/match/${match.fixture.id}`)}
                                  >
                                    <div className="flex items-center gap-2 flex-1 min-w-0">
                                      <img
                                    ...
                                    <div className="text-xs font-medium text-blue-600 dark:text-blue-400 mx-2">
                    ...
                    {/* Action Buttons */}
                    <div className="flex justify-around border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                      <button
