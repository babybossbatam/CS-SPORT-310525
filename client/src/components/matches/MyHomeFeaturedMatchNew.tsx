...
const MyFeaturedMatchSlide: React.FC<MyHomeFeaturedMatchNewProps> = ({
  ...
  // Simple sample data - replace this with your own data fetching logic
      ...
      <Card className="bg-white rounded-lg shadow-md mb-8 overflow-hidden relative">
        ...
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center py-8 text-gray-500">
            ...
            <p className="text-sm">Add your matches here</p>
          </div>
        </CardContent>
      </Card>
    );
              ...
              if (hasScore) {
                ...
                return (
                  <div className="flex flex-col items-center">
                    <div className="text-sm tracking-wide mt-1 text-gray-500">
                      {statusText}
                    </div>
                    <div
