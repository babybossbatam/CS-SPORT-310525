...
interface MatchLiveDetailsCardProps {
  homeTeam: string;
  awayTeam: string;
  homeTeamLogo?: string;
  awayTeamLogo?: string;
...
const MatchLiveDetailsCard: React.FC<MatchLiveDetailsCardProps> = ({
  homeTeam,
  awayTeam,
  homeTeamLogo,
  awayTeamLogo,
  ...
  return (
    <Card className="w-full mt-4">
      <CardHeader className="pb-3">
        <CardTitle className="text-sm text-gray-600 font-normal">Live Match</CardTitle>
      </CardHeader>
      <CardContent className="pt-0">
        <div className="text-center mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Live Action</h3>
...
export default MatchLiveDetailsCard;
