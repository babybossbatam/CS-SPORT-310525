  ...
  return (
    <Card className="bg-white rounded-lg shadow-md mb-6 overflow-hidden relative">
      ...
      <button
        ...
        className="absolute left-0 top-1/4 h-1/4 -translate-y-1/2 bg-gray-800/50 hover:bg-gray-800/75 text-white px-1 rounded-r z-30 flex items-center"
      >
      ...
      <button
        ...
        className="absolute right-0 top-1/4 h-1/4 -translate-y-1/2 bg-gray-800/50 hover:bg-gray-800/75 text-white px-1 rounded-l z-30 flex items-center"
      >
