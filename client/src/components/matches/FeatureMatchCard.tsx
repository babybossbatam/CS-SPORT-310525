  ...
  return (
    <Card className="bg-white rounded-lg shadow-md mb-6 overflow-hidden relative">
      ...
      <button
        ...
        className="absolute left-0 top-1/4 h-[14%] -translate-y-1/2 bg-gray-100 hover:bg-gray-200 text-black px-1 rounded-r-full z-30 flex items-center border border-gray-200"
      >
      ...
      <button
        ...
        className="absolute right-0 top-1/4 h-[14%] -translate-y-1/2 hover:bg-gray-100/10 text-black px-1 rounded-l-full z-30 flex items-center border border-gray-200"
      >
