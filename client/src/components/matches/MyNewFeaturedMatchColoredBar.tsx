...
interface MyNewFeaturedMatchColoredBarProps {
  homeTeam: Team;
  awayTeam: Team;
...
const MyNewFeaturedMatchColoredBar: React.FC<MyNewFeaturedMatchColoredBarProps> = ({
  homeTeam,
  awayTeam,
  homeScore,
  awayScore,
...
export default MyNewFeaturedMatchColoredBar;
