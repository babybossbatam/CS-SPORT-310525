            ...
            >
              ...
              <div className="flex justify-around border-t border-gray-200 pt-3">
                ...
                >
                  ...
                  <span className="text-[0.65rem] text-gray-600 mt-0.5">Lineups</span>
                </button>
                <button 
                  className="flex flex-col items-center cursor-pointer w-1/4"
                ...
                >
                  ...
                  <span className="text-[0.65rem] text-gray-600 mt-0.5">H2H</span>
                </button>
                <button 
                  className="flex flex-col items-center cursor-pointer w-1/4"
                ...
                >
                  ...
                  <span className="text-[0.65rem] text-gray-600 mt-0.5">Standings</span>
                </button>
              </div>
