      ...
      {matches.length > 1 && (
        <>
          <button
            ...
            className="absolute left-0 top-[50%] -translate-y-1/2 bg-gray-100 hover:bg-gray-200 text-black h-[64px] px-1 rounded-r-md z-40 flex items-center border border-gray-200"
            style={{left: "0px"}}
          >
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 top-[50%] -translate-y-1/2 bg-gray-100 hover:bg-gray-200 text-black h-[64px] px-1 rounded-l-md z-40 flex items-center border border-gray-200"
            style={{right: "0px"}}
          >
                  ...
                  <div className="w-full h-full flex justify-between relative">
                    ...
                    >
                      ...
                      {currentMatch.fixture.status.short === 'NS' && (
                        <div className="absolute text-center text-xs text-gray-500 w-[300px] left-[-13px] top-[calc(50%+32px)]" style={{ fontSize: '0.65rem', whiteSpace: 'nowrap', overflow: 'visible' }}>
                          {(() => {
                            try {
