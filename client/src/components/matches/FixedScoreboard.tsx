              ...
              <div className="relative">
                ...
                >
                  <div className="w-full h-full flex justify-between relative">
                    ...
                    <div className="h-full w-[calc(50%-82px)] mr-[52px]" 
                      style={{ 
                    ...
                    <div className="absolute text-white font-bold text-sm uppercase text-right max-w-[120px] truncate md:max-w-[200px]" style={{top: "calc(50% - 8px)", right: "50px"}}>
