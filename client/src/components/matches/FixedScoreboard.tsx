        ...
        {isLoading && matches.length === 0 ? (
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  <div className="w-full h-full flex justify-between relative">
                    ...
                    <div className="absolute text-white font-bold text-sm uppercase text-left max-w-[120px] truncate md:max-w-[200px]" style={{top: "calc(50% - 8px)", left: "100px"}}>
              ...
              <div className="absolute right-[100px] text-white font-bold text-sm uppercase text-right max-w-[120px] truncate md:max-w-[200px]" style={{top: "calc(50% - 8px)"}}>
              ...
              <div className="flex justify-around border-t border-gray-200 pt-3">
                ...
                >
                  <svg width="10" height="10" viewBox="0 0 24 24" className="text-gray-600">
                  ...
                  <span className="text-[0.5rem] text-gray-600 mt-0.5">Match Page</span>
                </button>
                <button 
                  className="flex flex-col items-center cursor-pointer w-1/4"
                ...
                >
                  ...
                  <span className="text-[0.5rem] text-gray-600 mt-0.5">Lineups</span>
                </button>
                <button 
                  className="flex flex-col items-center cursor-pointer w-1/4"
                ...
                >
                  ...
                  <span className="text-[0.5rem] text-gray-600 mt-0.5">H2H</span>
                </button>
                <button 
                  className="flex flex-col items-center cursor-pointer w-1/4"
                ...
                >
                  ...
                  <span className="text-[0.5rem] text-gray-600 mt-0.5">Standings</span>
                </button>
              </div>
