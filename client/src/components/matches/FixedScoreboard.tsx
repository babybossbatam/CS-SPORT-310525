          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="absolute top-0 left-0 right-0 z-40 flex flex-col items-center justify-center pt-2 pb-1 bg-white/95 backdrop-blur-sm">
                ...
                {/* Match date row */}
                <div className="text-xs text-black h-5 flex items-center justify-center">
                  {(() => {
                    try {
              ...
              <div className="relative">
                ...
                >
                  <div className="w-full h-full flex justify-between relative">
                    ...
                    <div className="absolute text-white font-bold text-sm uppercase text-left max-w-[120px] truncate md:max-w-[200px]" style={{top: "calc(50% - 8px)", left: "80px"}}>
