                        ...
                        <div className="space-y-2">
                          {leagueData.matches.map((match: any, index: number) => (
                            <div 
                              ...
                              className="bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-all duration-200 cursor-pointer group"
                            >
                              <div className="flex items-center px-4 py-3">
                                {/* Favorite Icon */}
                                <button className="text-gray-300 hover:text-blue-500 transition-colors duration-200 mr-3">
                                ...
                                <div className="flex items-center flex-1 min-w-0 justify-end">
                                  <TeamLogo
                                    ...
                                    size="sm"
                                  />
                                  <div className="text-sm font-medium text-gray-900 truncate ml-2">
