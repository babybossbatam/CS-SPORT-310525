...
const MyNewLeague2Component: React.FC<MyNewLeague2Props> = ({
  ...
  const leagueIds = [
    32, 38, 39, 140, 135, 29, 15, 2, 4, 10, 11, 848, 886, 1022, 772, 307, 71, 3,
    5, 531, 22, 72, 73, 75, 76, 233, 667, 301, 908, 1169, 23, 253, 850, 893,
    ...
    <>
      ...
      {leagueEntries
        .sort(([aId], [bId]) => {
          ...
          const priorityOrder = [
            32, 38, 39, 140, 29, 135, 850, 15, 2, 5, 22, 10, 11, 1022, 772, 307,
            71, 72, 667, 301, 3, 848, 73, 75, 239, 233, 253,
          ];
