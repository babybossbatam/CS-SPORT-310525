  ...
  return (
    <img
      ...
      style={{
        ...
        filter: 'drop-shadow(0 0 0 2px rgba(255, 255, 255, 0.9)) drop-shadow(0 0 8px rgba(255, 255, 255, 0.7)) drop-shadow(0 2px 4px rgba(0, 0, 0, 0.3)) drop-shadow(0 0 16px rgba(255, 255, 255, 0.4))',
