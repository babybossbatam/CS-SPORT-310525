      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between mr-[10%]">
        <Link href="/" className="flex-shrink-0 flex items-center h-full ml-[150px] bg-black">
          ...
          <span className="flex items-center gap-2 whitespace-nowrap">
            <span className="text-black font-bold text-[clamp(1.313rem,2vw,1.563rem)] transition-all duration-200 hover:text-white hover:drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]">CSSPORT</span>
          </span>
        </Link>
