      ...
      <div className="container mx-auto flex items-center justify-between h-full px-20">
        <Link href="/" className="flex-shrink-0 flex items-center h-full bg-black">
          ...
          <span className="flex items-center gap-2 whitespace-nowrap">
            <span className="bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-400 bg-clip-text text-transparent font-bold text-[clamp(2.219rem,2.6vw,2.642rem)] transition-all duration-200 hover:from-white hover:via-yellow-100 hover:to-amber-200 hover:drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]" style={{fontFamily: 'Roboto, sans-serif'}}>CSSPORT</span>
          </span>
        </Link>
