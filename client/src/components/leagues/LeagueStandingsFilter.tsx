              ...
              <div className="space-y-6">
                {standings.league.standings.slice(0, 2).map(
                  (group: Standing[], groupIndex: number) => (
                    <div key={groupIndex}>
                      <h3 className="text-xs font-regular mx-2 pt-2 mt-4 border-t border-b border-gray-100 dark:border-white mb-2 text-gray-700 dark:text-white flex items-center pb-1">
