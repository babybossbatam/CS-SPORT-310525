...
const BundesligaSchedule = () => {
  ...
  if (isLoading) {
    return (
      <Card className="mb-4">
        <CardHeader className="bg-gradient-to-r from-red-700 to-red-500 text-white p-3">
          <div className="flex items-center">
            <Layers className="h-5 w-5 mr-2" />
            <span className="font-semibold">Bundesliga</span>
          </div>
        </CardHeader>
      ...
      <Card className="mb-4">
        ...
        <CardContent className="p-4">
          <div className="text-center space-y-3">
            <div className="bg-red-50 text-red-800 p-3 rounded-md border border-red-100 text-sm">
              <p className="font-medium">We're having trouble connecting to the Bundesliga API.</p>
              <p className="mt-1 text-xs text-red-600">This data will be available soon.</p>
            </div>
            ...
            <div className="flex justify-center mt-4">
              <div className="relative w-32 h-32 opacity-50">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/128?text=Bundesliga';
                  }}
                />
              </div>
            </div>
        ...
        <CardContent className="p-4">
          <div className="text-center space-y-3">
            <div className="bg-yellow-50 text-yellow-800 p-3 rounded-md border border-yellow-100 text-sm">
              <p className="font-medium">No Bundesliga fixtures are currently available.</p>
      ...
      <CardHeader className="bg-gradient-to-r from-red-700 to-red-500 text-white p-3">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="flex items-center text-xs bg-red-800 hover:bg-red-900 px-2 py-1 rounded transition-colors"
          >
