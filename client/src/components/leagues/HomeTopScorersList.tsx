                    ...
                    <div key={scorer.player.id} className="flex items-center justify-between p-2 hover:bg-gray-50/50 rounded-lg transition-all duration-200 group">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                          <Avatar className="h-12 w-12 border-2 border-gray-100 group-hover:border-blue-100 transition-all duration-200 overflow-hidden shadow-lg relative">
                            <AvatarImage 
                              src={scorer.player.photo} 
                              alt={scorer.player.name}
                              className="object-cover object-center scale-125 contrast-110 brightness-110 hover:scale-140 transition-transform duration-200 transform-gpu translate-y-[-5%] hover:translate-y-[-8%]" 
                            />
