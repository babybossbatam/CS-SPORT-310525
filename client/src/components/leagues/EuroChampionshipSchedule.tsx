...
const EuroChampionshipSchedule = () => {
  const [, navigate] = useLocation();
  const [visibleFixtures, setVisibleFixtures] = useState<FixtureResponse[]>([]);
  
  // Euro Championship ID is 4
  const leagueId = 4;
  const currentYear = new Date().getFullYear();
  
  // Get Euro Championship info
      ...
      <Card className="mb-4">
        <CardHeader className="bg-gradient-to-r from-blue-700 to-blue-500 text-white p-3">
          <div className="flex items-center">
            ...
            <span className="font-semibold">Euro Championship</span>
          </div>
        </CardHeader>
        ...
        <CardContent className="p-4">
          <div className="text-center space-y-3">
            <div className="bg-blue-50 text-blue-800 p-3 rounded-md border border-blue-100 text-sm">
              <p className="font-medium">We're having trouble connecting to the Euro Championship API.</p>
            ...
            <div className="flex justify-center mt-4">
              <div className="relative w-32 h-32 opacity-50">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/128?text=Euro+Championship';
                  }}
                />
              </div>
            </div>
        ...
        <CardContent className="p-4">
          <div className="text-center space-y-3">
            <div className="bg-yellow-50 text-yellow-800 p-3 rounded-md border border-yellow-100 text-sm">
              <p className="font-medium">No Euro Championship fixtures are currently available.</p>
            ...
            <div className="flex justify-center mt-4">
              <div className="relative w-24 h-24 opacity-60">
                <img 
                  ...
                  className="w-full h-full object-contain"
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/96?text=Euro+Championship';
                  }}
                />
              </div>
            </div>
...
export default EuroChampionshipSchedule;