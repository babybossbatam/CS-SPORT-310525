      ...
      <Card className="mb-4">
        ...
        <CardContent className="p-4">
          <div className="text-center space-y-3">
            <div className="bg-sky-50 text-sky-800 p-3 rounded-md border border-sky-100 text-sm">
            ...
            <div className="flex justify-center mt-4">
              <div className="relative w-32 h-32 opacity-50">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/128?text=Serie+A';
                  }}
                />
              </div>
            </div>
            ...
            <div className="flex justify-center mt-4">
              <div className="relative w-24 h-24 opacity-60">
                <img 
                  ...
                  className="w-full h-full object-contain"
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/96?text=Serie+A';
                  }}
                />
              </div>
            </div>
