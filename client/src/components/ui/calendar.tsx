  ...
  return (
    <div className="flex justify-center p-0 bg-white">
      <DayPicker
        ...
        className={cn("p-6 bg-white w-full max-w-[500px] min-w-[450px]", className)}
        classNames={{
          ...
          nav_button: cn(
            "h-10 w-10 bg-white p-0 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-full flex items-center justify-center"
          ),
          nav_button_previous: "absolute left-3",
          nav_button_next: "absolute right-3",
          table: "w-full border-collapse bg-white min-w-[400px]",
          head_row: "flex mb-4",
          head_cell: "text-gray-600 flex-1 h-10 font-medium text-base text-center flex items-center justify-center min-w-[60px]",
          row: "flex w-full",
          cell: "flex-1 h-12 text-center text-base p-0 relative focus-within:relative focus-within:z-20 min-w-[60px]",
          day: cn(
            "h-12 w-full p-0 font-normal text-gray-800 hover:bg-blue-50 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-200 min-w-[60px]"
          ),
