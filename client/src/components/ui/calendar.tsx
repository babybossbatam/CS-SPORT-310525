  ...
  return (
    <div className="flex justify-center p-0 bg-white">
      <DayPicker
        ...
        className={cn("p-4 bg-white w-full max-w-[350px] min-w-[315px]", className)}
        classNames={{
          ...
          head_row: "flex mb-3",
          head_cell: "text-gray-600 flex-1 h-8 font-medium text-sm text-center flex items-center justify-center min-w-[42px]",
          row: "flex w-full",
          cell: "flex-1 h-9 text-center text-sm p-0 relative focus-within:relative focus-within:z-20 min-w-[42px]",
          day: cn(
            "h-9 w-full p-0 font-normal text-gray-800 hover:bg-blue-50 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-200 min-w-[42px]"
          ),
        ...
        {...props}
      />
      <div className="flex justify-center pb-3 pt-1 bg-white">
        <button
          onClick={handleTodayClick}
          className="text-blue-500 text-xs font-medium hover:text-blue-600 transition-colors bg-white cursor-pointer px-1 py-0.5"
        >
          Today
        </button>
      </div>
