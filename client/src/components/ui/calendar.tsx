    ...
    <div className="flex flex-col justify-center p-0 bg-white w-full">
      <DayPicker
        ...
        classNames={{
          ...
          head_cell: "text-gray-600 flex-1 h-14 font-medium text-sm text-center flex items-center justify-center min-w-[65px]",
          row: "flex w-full mb-2",
          cell: "flex-1 h-14 text-center text-sm p-1 relative focus-within:relative focus-within:z-20 min-w-[65px]",
          day: cn(
            "h-14 w-full p-0 font-normal text-gray-800 hover:bg-blue-50 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-200 min-w-[63px]"
          ),
