                ...
                <div className="space-y-4">
                  ...
                  <div className="text-xs text-gray-600 space-y-3">
                    <div>
                      ...
                      <p>Football's roots go way back! While ball games have been played for centuries across the world, the modern game was shaped in England in the 19th century. The English Football Association set the official rules in 1863, giving us the Football we know and love today.</p>
                    </div>

                    <div>
                      <h3 className="font-medium text-gray-800 my-2 text-xs">Where was Football invented?</h3>
                      <p>The modern version of Football was born in England. Although similar games existed globally, it was in England where the rules were standardized, making it the home of modern Football.</p>
                    </div>

                    <div>
                      <h3 className="font-medium text-gray-800 my-2 text-xs">What is the length of a Football pitch?</h3>
                      <p>Great question! A standard Football pitch is rectangular, ranging from 90–120 meters in length and 45–90 meters in width, as set by the International Football Association Board (IFAB). These dimensions are used for professional and international matches.</p>
                    </div>

                    <div>
                      <h3 className="font-medium text-gray-800 my-2 text-xs">Who is the best Football player in the world?</h3>
                      <p>This is always up for debate! Legends like Pelé, Diego Maradona, Lionel Messi, and Cristiano Ronaldo have all left their mark. Each has a unique style and legacy, so the "best" often depends on who you ask!</p>
                    </div>

                    <div>
                      <h3 className="font-medium text-gray-800 my-2 text-xs">Want more Football fun?</h3>
                      <p>Check out live stats, highlights, and join the conversation with fans worldwide – only on</p>
                  ...
                  <button 
                    onClick={toggleExpanded}
                    className="w-full flex items-center justify-center gap-2 py-2 mt-4 border-t border-gray-200 text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200"
                  >
                    <span>Show Less</span>
                    <ChevronUp size={16} />
                  </button>
