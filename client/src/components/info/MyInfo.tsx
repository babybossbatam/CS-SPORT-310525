            ...
            <div>
              ...
              {isExpanded && (
                <div className="space-y-4">
                  ...
                  <button 
                    onClick={toggleExpanded}
                    className="w-full flex items-center justify-center gap-2 py-2 mt-4 border-t text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200"
                  >
                    <span>Show Less</span>
                    <ChevronUp size={16} />
                  </button>
