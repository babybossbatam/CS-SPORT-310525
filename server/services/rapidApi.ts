...
// OPTIMIZED: Much longer cache durations to prevent API overload
const LIVE_DATA_CACHE_DURATION = 30 * 60 * 1000; // 30 minutes for live data (tripled)
const TODAY_CACHE_DURATION = 2 * 60 * 60 * 1000; // 2 hours for today (doubled again)
const FUTURE_CACHE_DURATION = 48 * 60 * 60 * 1000; // 48 hours for future dates (doubled)
const PAST_CACHE_DURATION = 14 * 24 * 60 * 60 * 1000; // 14 days for past dates (doubled)
const STATIC_DATA_CACHE_DURATION = 48 * 60 * 60 * 1000; // 48 hours for static data (doubled)
